...
#define NRPNL_CAL_VOLTS     15
#define NRPNL_SAVE          100

// parameters for the gain calibration process
#define GAIN_CAL_BASE_VOLTS  1
#define GAIN_CAL_BASE_MV (1000*GAIN_CAL_BASE_VOLTS)
#define GAIN_CAL_INTERVAL_MV 1000
#define GAIN_CAL_CYCLES     6

// parameters for the offset calibration process
#define OFS_CAL_BASE_VOLTS  1
#define OFS_CAL_BASE_MV (1000*OFS_CAL_BASE_VOLTS)
#define OFS_CAL_INTERVAL_MV 1000
...
void set_scale_adj(byte which, int amount) 
{
  ...
  send_nrpn(NRPNH_CV1 + which, NRPNL_CAL_SCALE, sign, amount);
}
...
void set_ofs_adj(byte which, int amount) 
{
  ...
  send_nrpn(NRPNH_CV1 + which, NRPNL_CAL_OFS, sign, amount);
}
...
void test_volts(byte which, byte volts, double *mv) {

  send_nrpn(NRPNH_CV1, NRPNL_CAL_VOLTS, 0, volts);
